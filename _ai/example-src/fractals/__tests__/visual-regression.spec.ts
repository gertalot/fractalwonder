// ABOUTME: Visual regression tests using Playwright for fractal rendering
// ABOUTME: Detects blockiness and visual artifacts at extreme zoom levels
...
test.beforeEach(async ({ page }) => {
  ...
  test("should detect blockiness at zoom 10^13", async ({ page }) => {
    ...
    console.log(`Blockiness analysis: ${blockinessAnalysis?.identicalBlocks} identical blocks out of ${blockinessAnalysis?.totalBlocks} total blocks`);
