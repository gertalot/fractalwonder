// ABOUTME: Color scheme functions for fractal rendering
// ABOUTME: Maps iteration counts to RGB color values
 ...
 * @returns RGB tuple with values 0-255: [red, green, blue]
 */
export function smoothLoopingColorScheme(
  iter: number,
 ...
 * @returns RGB tuple with values 0-255: [red, green, blue]
 */
export function fireColorScheme(
  iter: number,
  maxIterations: number
): [number, number, number] {
  // Points that never escaped are in the set - render as black
